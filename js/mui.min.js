...
//解决header举例顶部太近的问题 : 挡住了系统状态栏
function setHeaderNav(){
	//获取系统状态栏的高度
	let status_height = mui.plusReady(function(){
		plus.navigator.getStatusbarHeight();
	})
	//console.log(status_height)
	document.querySelector(".common-header").style.paddingTop = status_height + 'px';
	document.querySelector(".common-header").style.height = 44 + status_height + 'px';
}
